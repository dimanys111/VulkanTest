...
VkBool32 WindowManager::debugCallback(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity,
...
bool WindowManager::GetClose() { return glfwWindowShouldClose(window); }
